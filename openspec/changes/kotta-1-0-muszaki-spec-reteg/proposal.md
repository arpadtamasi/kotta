...
- **Nincs kompatibilitási réteg.** A régi folyamatmotor a régi kiadásként (`@arpadtamasi/kotta@0.11.x`) marad telepíthető; az 1.0 nem tartja meg a régi parancsokat, hanem `kotta migrate`-et ad, amely a `process/` adatot csak olvasható `legacy/` archívumba viszi, a spec-et változatlanul hagyja.
...
- Az `@arpadtamasi/kotta` felülete törik; a változás major verzió. A hét meglévő workspace a régi kiadással működik tovább, amíg migrálva nincs; az 1.0 egy migrálatlan workspace-ben csak a migrációt ajánlja fel.
