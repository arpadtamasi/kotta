...
5. Verify that the task moved to done, the claim was released, safe worktree and local-branch cleanup occurred, the containing batch was updated, and `.kotta/process/index.md` was regenerated.
