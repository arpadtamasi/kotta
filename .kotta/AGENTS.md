...
```bash
npm install --global @arpadtamasi/kotta@0.7.0   # or: npx -y -p @arpadtamasi/kotta@0.7.0 kotta status
```
...
Markdown specification nodes under `.kotta/spec/`; they never make specification a lifecycle gate.
