...
|---|---|
| `kotta contract revise <id> --reason "…" --approve` moves a `defined` contract to `backlog`, and | Implemented contract revise for defined and active contracts, claim release back to defined, preserved branch/worktree reuse, lifecycle reason/status reporting, CLI and caller-chat approval surfaces, documentation and regression coverage. During continuation, added the missing caller-chat revise test and fixed scoped reason payload validation in fa352eb. Verification: focused revise/MCP tests (11 passed); npm run typecheck; npm run build via npm test; npm test (275 passed, 1 skipped); kotta validate. Operation-registry work has not landed on this branch, so the handwritten approval/MCP surfaces are the applicable implementation order. |
| The same command on an `active` contract with a clean worktree releases the claim, preserves the | Implemented contract revise for defined and active contracts, claim release back to defined, preserved branch/worktree reuse, lifecycle reason/status reporting, CLI and caller-chat approval surfaces, documentation and regression coverage. During continuation, added the missing caller-chat revise test and fixed scoped reason payload validation in fa352eb. Verification: focused revise/MCP tests (11 passed); npm run typecheck; npm run build via npm test; npm test (275 passed, 1 skipped); kotta validate. Operation-registry work has not landed on this branch, so the handwritten approval/MCP surfaces are the applicable implementation order. |
| `revise` without `--approve` refuses; without `--reason` it refuses; on a `review` or `done` | Implemented contract revise for defined and active contracts, claim release back to defined, preserved branch/worktree reuse, lifecycle reason/status reporting, CLI and caller-chat approval surfaces, documentation and regression coverage. During continuation, added the missing caller-chat revise test and fixed scoped reason payload validation in fa352eb. Verification: focused revise/MCP tests (11 passed); npm run typecheck; npm run build via npm test; npm test (275 passed, 1 skipped); kotta validate. Operation-registry work has not landed on this branch, so the handwritten approval/MCP surfaces are the applicable implementation order. |
| `revise` on an `active` contract whose worktree has uncommitted changes refuses, names the | Implemented contract revise for defined and active contracts, claim release back to defined, preserved branch/worktree reuse, lifecycle reason/status reporting, CLI and caller-chat approval surfaces, documentation and regression coverage. During continuation, added the missing caller-chat revise test and fixed scoped reason payload validation in fa352eb. Verification: focused revise/MCP tests (11 passed); npm run typecheck; npm run build via npm test; npm test (275 passed, 1 skipped); kotta validate. Operation-registry work has not landed on this branch, so the handwritten approval/MCP surfaces are the applicable implementation order. |
| `kotta claim release <id> --force` on an `active` contract leaves it at `defined`, and | Implemented contract revise for defined and active contracts, claim release back to defined, preserved branch/worktree reuse, lifecycle reason/status reporting, CLI and caller-chat approval surfaces, documentation and regression coverage. During continuation, added the missing caller-chat revise test and fixed scoped reason payload validation in fa352eb. Verification: focused revise/MCP tests (11 passed); npm run typecheck; npm run build via npm test; npm test (275 passed, 1 skipped); kotta validate. Operation-registry work has not landed on this branch, so the handwritten approval/MCP surfaces are the applicable implementation order. |
| After a `revise`, the contract's lifecycle events carry the previous state, the reason and whether | Implemented contract revise for defined and active contracts, claim release back to defined, preserved branch/worktree reuse, lifecycle reason/status reporting, CLI and caller-chat approval surfaces, documentation and regression coverage. During continuation, added the missing caller-chat revise test and fixed scoped reason payload validation in fa352eb. Verification: focused revise/MCP tests (11 passed); npm run typecheck; npm run build via npm test; npm test (275 passed, 1 skipped); kotta validate. Operation-registry work has not landed on this branch, so the handwritten approval/MCP surfaces are the applicable implementation order. |
| `kotta status` shows the revised contract with its reason. | Implemented contract revise for defined and active contracts, claim release back to defined, preserved branch/worktree reuse, lifecycle reason/status reporting, CLI and caller-chat approval surfaces, documentation and regression coverage. During continuation, added the missing caller-chat revise test and fixed scoped reason payload validation in fa352eb. Verification: focused revise/MCP tests (11 passed); npm run typecheck; npm run build via npm test; npm test (275 passed, 1 skipped); kotta validate. Operation-registry work has not landed on this branch, so the handwritten approval/MCP surfaces are the applicable implementation order. |
| The calling chat can perform a revision through the same structured surface as the other gated | Implemented contract revise for defined and active contracts, claim release back to defined, preserved branch/worktree reuse, lifecycle reason/status reporting, CLI and caller-chat approval surfaces, documentation and regression coverage. During continuation, added the missing caller-chat revise test and fixed scoped reason payload validation in fa352eb. Verification: focused revise/MCP tests (11 passed); npm run typecheck; npm run build via npm test; npm test (275 passed, 1 skipped); kotta validate. Operation-registry work has not landed on this branch, so the handwritten approval/MCP surfaces are the applicable implementation order. |
| No path in this contract requires editing a file under `.kotta/` by hand. | Implemented contract revise for defined and active contracts, claim release back to defined, preserved branch/worktree reuse, lifecycle reason/status reporting, CLI and caller-chat approval surfaces, documentation and regression coverage. During continuation, added the missing caller-chat revise test and fixed scoped reason payload validation in fa352eb. Verification: focused revise/MCP tests (11 passed); npm run typecheck; npm run build via npm test; npm test (275 passed, 1 skipped); kotta validate. Operation-registry work has not landed on this branch, so the handwritten approval/MCP surfaces are the applicable implementation order. |
...
| workflow: authorization_and_idempotency_verified | Implemented contract revise for defined and active contracts, claim release back to defined, preserved branch/worktree reuse, lifecycle reason/status reporting, CLI and caller-chat approval surfaces, documentation and regression coverage. During continuation, added the missing caller-chat revise test and fixed scoped reason payload validation in fa352eb. Verification: focused revise/MCP tests (11 passed); npm run typecheck; npm run build via npm test; npm test (275 passed, 1 skipped); kotta validate. Operation-registry work has not landed on this branch, so the handwritten approval/MCP surfaces are the applicable implementation order. |
...
The separate manual throwaway lifecycle was not repeated; tests/integration/revise.test.ts exercises the same defined and active revision, redefine, claim-release, dirty-worktree refusal and lifecycle-audit paths.
...
This feature branch predates the current 0.7 main line; integration will require reconciliation with later approval, cancel and MCP changes before merge.
