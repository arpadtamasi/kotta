...
|---|---|
| `kotta contract cancel <id> --resolution obsolete --reason "…" --superseded-by <decision-id> | Implemented on feat/T-01kzrdybqzgpmv3ff0wqv7bbf8-objectless-work-is-retired-by-name-and-the-record-says-what- at b48022e, branched from main.  cancelContract (src/commands/contract.ts) now accepts backlog, defined, active and review; a done contract is refused by name and pointed at reopen. From active and review it removes the claim and the execution worktree and preserves the branch, reusing closeContract's clean-worktree guard rather than releaseClaim, so a contract whose worktree vanished can still be retired instead of being trapped. --reason is required from every state and stored as cancellation_reason; --superseded-by resolves a contract or decision to its canonical id, is stored as superseded_by, and is required for duplicate and obsolete. A supersession that names nothing, names a missing entity, or names the contract itself is refused. The id is canonicalised once so the short form the listings print cannot silently miss the claim and worktree paths. The lifecycle event carries the previous state, resolution, reason, superseding id, claim release and preserved branch; the CLI approval receipt records the same payload. Dependent contracts are reported in the result and never cascaded.  contract.cancel is a gated approval action (src/commands/approval.ts, src/commands/mcp.ts): payload validated for resolution, reason and supersededBy; assertApplicable admits every state but done; approvalDescription puts the resolution, the supersession and the reason into the sentence the human reads. showCommand (src/commands/show.ts) lists a decision's retired contracts, derived from the contracts themselves so decision files keep their three fields.  Verification: npx vitest run tests/integration/contract-cancel.test.ts — 11 tests, covering cancel from backlog, active (claim released, worktree removed, branch alive, event and receipt asserted), review, a vanished worktree, dependents reported, and every refusal (no approval, blank reason, missing --reason, unknown resolution, unnamed/dangling/circular supersession, a second cancel). tests/integration/mcp.test.ts adds the caller-chat path: a payload missing supersededBy is refused before any event is written, and an approved contract.cancel moves the contract to done with proposed/approved/applied. npm run typecheck, npm run build and npx vitest run --exclude '.worktrees/**' all pass: 42 files, 275 passed, 1 skipped. Documentation: README.md, AGENTS.md lifecycle table and prose, skills/close-contract and skills/execute-contract. |
| The same command retires a `review` contract, with the same result. | Implemented on feat/T-01kzrdybqzgpmv3ff0wqv7bbf8-objectless-work-is-retired-by-name-and-the-record-says-what- at b48022e, branched from main.  cancelContract (src/commands/contract.ts) now accepts backlog, defined, active and review; a done contract is refused by name and pointed at reopen. From active and review it removes the claim and the execution worktree and preserves the branch, reusing closeContract's clean-worktree guard rather than releaseClaim, so a contract whose worktree vanished can still be retired instead of being trapped. --reason is required from every state and stored as cancellation_reason; --superseded-by resolves a contract or decision to its canonical id, is stored as superseded_by, and is required for duplicate and obsolete. A supersession that names nothing, names a missing entity, or names the contract itself is refused. The id is canonicalised once so the short form the listings print cannot silently miss the claim and worktree paths. The lifecycle event carries the previous state, resolution, reason, superseding id, claim release and preserved branch; the CLI approval receipt records the same payload. Dependent contracts are reported in the result and never cascaded.  contract.cancel is a gated approval action (src/commands/approval.ts, src/commands/mcp.ts): payload validated for resolution, reason and supersededBy; assertApplicable admits every state but done; approvalDescription puts the resolution, the supersession and the reason into the sentence the human reads. showCommand (src/commands/show.ts) lists a decision's retired contracts, derived from the contracts themselves so decision files keep their three fields.  Verification: npx vitest run tests/integration/contract-cancel.test.ts — 11 tests, covering cancel from backlog, active (claim released, worktree removed, branch alive, event and receipt asserted), review, a vanished worktree, dependents reported, and every refusal (no approval, blank reason, missing --reason, unknown resolution, unnamed/dangling/circular supersession, a second cancel). tests/integration/mcp.test.ts adds the caller-chat path: a payload missing supersededBy is refused before any event is written, and an approved contract.cancel moves the contract to done with proposed/approved/applied. npm run typecheck, npm run build and npx vitest run --exclude '.worktrees/**' all pass: 42 files, 275 passed, 1 skipped. Documentation: README.md, AGENTS.md lifecycle table and prose, skills/close-contract and skills/execute-contract. |
| The same command still retires a `backlog` and a `defined` contract, now recording the reason. | Implemented on feat/T-01kzrdybqzgpmv3ff0wqv7bbf8-objectless-work-is-retired-by-name-and-the-record-says-what- at b48022e, branched from main.  cancelContract (src/commands/contract.ts) now accepts backlog, defined, active and review; a done contract is refused by name and pointed at reopen. From active and review it removes the claim and the execution worktree and preserves the branch, reusing closeContract's clean-worktree guard rather than releaseClaim, so a contract whose worktree vanished can still be retired instead of being trapped. --reason is required from every state and stored as cancellation_reason; --superseded-by resolves a contract or decision to its canonical id, is stored as superseded_by, and is required for duplicate and obsolete. A supersession that names nothing, names a missing entity, or names the contract itself is refused. The id is canonicalised once so the short form the listings print cannot silently miss the claim and worktree paths. The lifecycle event carries the previous state, resolution, reason, superseding id, claim release and preserved branch; the CLI approval receipt records the same payload. Dependent contracts are reported in the result and never cascaded.  contract.cancel is a gated approval action (src/commands/approval.ts, src/commands/mcp.ts): payload validated for resolution, reason and supersededBy; assertApplicable admits every state but done; approvalDescription puts the resolution, the supersession and the reason into the sentence the human reads. showCommand (src/commands/show.ts) lists a decision's retired contracts, derived from the contracts themselves so decision files keep their three fields.  Verification: npx vitest run tests/integration/contract-cancel.test.ts — 11 tests, covering cancel from backlog, active (claim released, worktree removed, branch alive, event and receipt asserted), review, a vanished worktree, dependents reported, and every refusal (no approval, blank reason, missing --reason, unknown resolution, unnamed/dangling/circular supersession, a second cancel). tests/integration/mcp.test.ts adds the caller-chat path: a payload missing supersededBy is refused before any event is written, and an approved contract.cancel moves the contract to done with proposed/approved/applied. npm run typecheck, npm run build and npx vitest run --exclude '.worktrees/**' all pass: 42 files, 275 passed, 1 skipped. Documentation: README.md, AGENTS.md lifecycle table and prose, skills/close-contract and skills/execute-contract. |
| Cancelling without `--approve` refuses; without `--reason` refuses; with `--resolution obsolete` or | Implemented on feat/T-01kzrdybqzgpmv3ff0wqv7bbf8-objectless-work-is-retired-by-name-and-the-record-says-what- at b48022e, branched from main.  cancelContract (src/commands/contract.ts) now accepts backlog, defined, active and review; a done contract is refused by name and pointed at reopen. From active and review it removes the claim and the execution worktree and preserves the branch, reusing closeContract's clean-worktree guard rather than releaseClaim, so a contract whose worktree vanished can still be retired instead of being trapped. --reason is required from every state and stored as cancellation_reason; --superseded-by resolves a contract or decision to its canonical id, is stored as superseded_by, and is required for duplicate and obsolete. A supersession that names nothing, names a missing entity, or names the contract itself is refused. The id is canonicalised once so the short form the listings print cannot silently miss the claim and worktree paths. The lifecycle event carries the previous state, resolution, reason, superseding id, claim release and preserved branch; the CLI approval receipt records the same payload. Dependent contracts are reported in the result and never cascaded.  contract.cancel is a gated approval action (src/commands/approval.ts, src/commands/mcp.ts): payload validated for resolution, reason and supersededBy; assertApplicable admits every state but done; approvalDescription puts the resolution, the supersession and the reason into the sentence the human reads. showCommand (src/commands/show.ts) lists a decision's retired contracts, derived from the contracts themselves so decision files keep their three fields.  Verification: npx vitest run tests/integration/contract-cancel.test.ts — 11 tests, covering cancel from backlog, active (claim released, worktree removed, branch alive, event and receipt asserted), review, a vanished worktree, dependents reported, and every refusal (no approval, blank reason, missing --reason, unknown resolution, unnamed/dangling/circular supersession, a second cancel). tests/integration/mcp.test.ts adds the caller-chat path: a payload missing supersededBy is refused before any event is written, and an approved contract.cancel moves the contract to done with proposed/approved/applied. npm run typecheck, npm run build and npx vitest run --exclude '.worktrees/**' all pass: 42 files, 275 passed, 1 skipped. Documentation: README.md, AGENTS.md lifecycle table and prose, skills/close-contract and skills/execute-contract. |
| Cancelling an `active` contract whose execution worktree has uncommitted changes refuses, names the | Implemented on feat/T-01kzrdybqzgpmv3ff0wqv7bbf8-objectless-work-is-retired-by-name-and-the-record-says-what- at b48022e, branched from main.  cancelContract (src/commands/contract.ts) now accepts backlog, defined, active and review; a done contract is refused by name and pointed at reopen. From active and review it removes the claim and the execution worktree and preserves the branch, reusing closeContract's clean-worktree guard rather than releaseClaim, so a contract whose worktree vanished can still be retired instead of being trapped. --reason is required from every state and stored as cancellation_reason; --superseded-by resolves a contract or decision to its canonical id, is stored as superseded_by, and is required for duplicate and obsolete. A supersession that names nothing, names a missing entity, or names the contract itself is refused. The id is canonicalised once so the short form the listings print cannot silently miss the claim and worktree paths. The lifecycle event carries the previous state, resolution, reason, superseding id, claim release and preserved branch; the CLI approval receipt records the same payload. Dependent contracts are reported in the result and never cascaded.  contract.cancel is a gated approval action (src/commands/approval.ts, src/commands/mcp.ts): payload validated for resolution, reason and supersededBy; assertApplicable admits every state but done; approvalDescription puts the resolution, the supersession and the reason into the sentence the human reads. showCommand (src/commands/show.ts) lists a decision's retired contracts, derived from the contracts themselves so decision files keep their three fields.  Verification: npx vitest run tests/integration/contract-cancel.test.ts — 11 tests, covering cancel from backlog, active (claim released, worktree removed, branch alive, event and receipt asserted), review, a vanished worktree, dependents reported, and every refusal (no approval, blank reason, missing --reason, unknown resolution, unnamed/dangling/circular supersession, a second cancel). tests/integration/mcp.test.ts adds the caller-chat path: a payload missing supersededBy is refused before any event is written, and an approved contract.cancel moves the contract to done with proposed/approved/applied. npm run typecheck, npm run build and npx vitest run --exclude '.worktrees/**' all pass: 42 files, 275 passed, 1 skipped. Documentation: README.md, AGENTS.md lifecycle table and prose, skills/close-contract and skills/execute-contract. |
| Cancelling an `active` contract whose worktree is missing succeeds and releases the claim. | Implemented on feat/T-01kzrdybqzgpmv3ff0wqv7bbf8-objectless-work-is-retired-by-name-and-the-record-says-what- at b48022e, branched from main.  cancelContract (src/commands/contract.ts) now accepts backlog, defined, active and review; a done contract is refused by name and pointed at reopen. From active and review it removes the claim and the execution worktree and preserves the branch, reusing closeContract's clean-worktree guard rather than releaseClaim, so a contract whose worktree vanished can still be retired instead of being trapped. --reason is required from every state and stored as cancellation_reason; --superseded-by resolves a contract or decision to its canonical id, is stored as superseded_by, and is required for duplicate and obsolete. A supersession that names nothing, names a missing entity, or names the contract itself is refused. The id is canonicalised once so the short form the listings print cannot silently miss the claim and worktree paths. The lifecycle event carries the previous state, resolution, reason, superseding id, claim release and preserved branch; the CLI approval receipt records the same payload. Dependent contracts are reported in the result and never cascaded.  contract.cancel is a gated approval action (src/commands/approval.ts, src/commands/mcp.ts): payload validated for resolution, reason and supersededBy; assertApplicable admits every state but done; approvalDescription puts the resolution, the supersession and the reason into the sentence the human reads. showCommand (src/commands/show.ts) lists a decision's retired contracts, derived from the contracts themselves so decision files keep their three fields.  Verification: npx vitest run tests/integration/contract-cancel.test.ts — 11 tests, covering cancel from backlog, active (claim released, worktree removed, branch alive, event and receipt asserted), review, a vanished worktree, dependents reported, and every refusal (no approval, blank reason, missing --reason, unknown resolution, unnamed/dangling/circular supersession, a second cancel). tests/integration/mcp.test.ts adds the caller-chat path: a payload missing supersededBy is refused before any event is written, and an approved contract.cancel moves the contract to done with proposed/approved/applied. npm run typecheck, npm run build and npx vitest run --exclude '.worktrees/**' all pass: 42 files, 275 passed, 1 skipped. Documentation: README.md, AGENTS.md lifecycle table and prose, skills/close-contract and skills/execute-contract. |
| The lifecycle event for a cancellation carries the previous state, the resolution, the reason, the | Implemented on feat/T-01kzrdybqzgpmv3ff0wqv7bbf8-objectless-work-is-retired-by-name-and-the-record-says-what- at b48022e, branched from main.  cancelContract (src/commands/contract.ts) now accepts backlog, defined, active and review; a done contract is refused by name and pointed at reopen. From active and review it removes the claim and the execution worktree and preserves the branch, reusing closeContract's clean-worktree guard rather than releaseClaim, so a contract whose worktree vanished can still be retired instead of being trapped. --reason is required from every state and stored as cancellation_reason; --superseded-by resolves a contract or decision to its canonical id, is stored as superseded_by, and is required for duplicate and obsolete. A supersession that names nothing, names a missing entity, or names the contract itself is refused. The id is canonicalised once so the short form the listings print cannot silently miss the claim and worktree paths. The lifecycle event carries the previous state, resolution, reason, superseding id, claim release and preserved branch; the CLI approval receipt records the same payload. Dependent contracts are reported in the result and never cascaded.  contract.cancel is a gated approval action (src/commands/approval.ts, src/commands/mcp.ts): payload validated for resolution, reason and supersededBy; assertApplicable admits every state but done; approvalDescription puts the resolution, the supersession and the reason into the sentence the human reads. showCommand (src/commands/show.ts) lists a decision's retired contracts, derived from the contracts themselves so decision files keep their three fields.  Verification: npx vitest run tests/integration/contract-cancel.test.ts — 11 tests, covering cancel from backlog, active (claim released, worktree removed, branch alive, event and receipt asserted), review, a vanished worktree, dependents reported, and every refusal (no approval, blank reason, missing --reason, unknown resolution, unnamed/dangling/circular supersession, a second cancel). tests/integration/mcp.test.ts adds the caller-chat path: a payload missing supersededBy is refused before any event is written, and an approved contract.cancel moves the contract to done with proposed/approved/applied. npm run typecheck, npm run build and npx vitest run --exclude '.worktrees/**' all pass: 42 files, 275 passed, 1 skipped. Documentation: README.md, AGENTS.md lifecycle table and prose, skills/close-contract and skills/execute-contract. |
| `kotta show decision <id>` lists the contracts that name it in `superseded_by`. | Implemented on feat/T-01kzrdybqzgpmv3ff0wqv7bbf8-objectless-work-is-retired-by-name-and-the-record-says-what- at b48022e, branched from main.  cancelContract (src/commands/contract.ts) now accepts backlog, defined, active and review; a done contract is refused by name and pointed at reopen. From active and review it removes the claim and the execution worktree and preserves the branch, reusing closeContract's clean-worktree guard rather than releaseClaim, so a contract whose worktree vanished can still be retired instead of being trapped. --reason is required from every state and stored as cancellation_reason; --superseded-by resolves a contract or decision to its canonical id, is stored as superseded_by, and is required for duplicate and obsolete. A supersession that names nothing, names a missing entity, or names the contract itself is refused. The id is canonicalised once so the short form the listings print cannot silently miss the claim and worktree paths. The lifecycle event carries the previous state, resolution, reason, superseding id, claim release and preserved branch; the CLI approval receipt records the same payload. Dependent contracts are reported in the result and never cascaded.  contract.cancel is a gated approval action (src/commands/approval.ts, src/commands/mcp.ts): payload validated for resolution, reason and supersededBy; assertApplicable admits every state but done; approvalDescription puts the resolution, the supersession and the reason into the sentence the human reads. showCommand (src/commands/show.ts) lists a decision's retired contracts, derived from the contracts themselves so decision files keep their three fields.  Verification: npx vitest run tests/integration/contract-cancel.test.ts — 11 tests, covering cancel from backlog, active (claim released, worktree removed, branch alive, event and receipt asserted), review, a vanished worktree, dependents reported, and every refusal (no approval, blank reason, missing --reason, unknown resolution, unnamed/dangling/circular supersession, a second cancel). tests/integration/mcp.test.ts adds the caller-chat path: a payload missing supersededBy is refused before any event is written, and an approved contract.cancel moves the contract to done with proposed/approved/applied. npm run typecheck, npm run build and npx vitest run --exclude '.worktrees/**' all pass: 42 files, 275 passed, 1 skipped. Documentation: README.md, AGENTS.md lifecycle table and prose, skills/close-contract and skills/execute-contract. |
| The calling chat can retire a contract through `approval_request` with `contract.cancel`, without | Implemented on feat/T-01kzrdybqzgpmv3ff0wqv7bbf8-objectless-work-is-retired-by-name-and-the-record-says-what- at b48022e, branched from main.  cancelContract (src/commands/contract.ts) now accepts backlog, defined, active and review; a done contract is refused by name and pointed at reopen. From active and review it removes the claim and the execution worktree and preserves the branch, reusing closeContract's clean-worktree guard rather than releaseClaim, so a contract whose worktree vanished can still be retired instead of being trapped. --reason is required from every state and stored as cancellation_reason; --superseded-by resolves a contract or decision to its canonical id, is stored as superseded_by, and is required for duplicate and obsolete. A supersession that names nothing, names a missing entity, or names the contract itself is refused. The id is canonicalised once so the short form the listings print cannot silently miss the claim and worktree paths. The lifecycle event carries the previous state, resolution, reason, superseding id, claim release and preserved branch; the CLI approval receipt records the same payload. Dependent contracts are reported in the result and never cascaded.  contract.cancel is a gated approval action (src/commands/approval.ts, src/commands/mcp.ts): payload validated for resolution, reason and supersededBy; assertApplicable admits every state but done; approvalDescription puts the resolution, the supersession and the reason into the sentence the human reads. showCommand (src/commands/show.ts) lists a decision's retired contracts, derived from the contracts themselves so decision files keep their three fields.  Verification: npx vitest run tests/integration/contract-cancel.test.ts — 11 tests, covering cancel from backlog, active (claim released, worktree removed, branch alive, event and receipt asserted), review, a vanished worktree, dependents reported, and every refusal (no approval, blank reason, missing --reason, unknown resolution, unnamed/dangling/circular supersession, a second cancel). tests/integration/mcp.test.ts adds the caller-chat path: a payload missing supersededBy is refused before any event is written, and an approved contract.cancel moves the contract to done with proposed/approved/applied. npm run typecheck, npm run build and npx vitest run --exclude '.worktrees/**' all pass: 42 files, 275 passed, 1 skipped. Documentation: README.md, AGENTS.md lifecycle table and prose, skills/close-contract and skills/execute-contract. |
| A cancelled `review` contract validates without review evidence, and `kotta validate` passes. | Implemented on feat/T-01kzrdybqzgpmv3ff0wqv7bbf8-objectless-work-is-retired-by-name-and-the-record-says-what- at b48022e, branched from main.  cancelContract (src/commands/contract.ts) now accepts backlog, defined, active and review; a done contract is refused by name and pointed at reopen. From active and review it removes the claim and the execution worktree and preserves the branch, reusing closeContract's clean-worktree guard rather than releaseClaim, so a contract whose worktree vanished can still be retired instead of being trapped. --reason is required from every state and stored as cancellation_reason; --superseded-by resolves a contract or decision to its canonical id, is stored as superseded_by, and is required for duplicate and obsolete. A supersession that names nothing, names a missing entity, or names the contract itself is refused. The id is canonicalised once so the short form the listings print cannot silently miss the claim and worktree paths. The lifecycle event carries the previous state, resolution, reason, superseding id, claim release and preserved branch; the CLI approval receipt records the same payload. Dependent contracts are reported in the result and never cascaded.  contract.cancel is a gated approval action (src/commands/approval.ts, src/commands/mcp.ts): payload validated for resolution, reason and supersededBy; assertApplicable admits every state but done; approvalDescription puts the resolution, the supersession and the reason into the sentence the human reads. showCommand (src/commands/show.ts) lists a decision's retired contracts, derived from the contracts themselves so decision files keep their three fields.  Verification: npx vitest run tests/integration/contract-cancel.test.ts — 11 tests, covering cancel from backlog, active (claim released, worktree removed, branch alive, event and receipt asserted), review, a vanished worktree, dependents reported, and every refusal (no approval, blank reason, missing --reason, unknown resolution, unnamed/dangling/circular supersession, a second cancel). tests/integration/mcp.test.ts adds the caller-chat path: a payload missing supersededBy is refused before any event is written, and an approved contract.cancel moves the contract to done with proposed/approved/applied. npm run typecheck, npm run build and npx vitest run --exclude '.worktrees/**' all pass: 42 files, 275 passed, 1 skipped. Documentation: README.md, AGENTS.md lifecycle table and prose, skills/close-contract and skills/execute-contract. |
| `kotta validate`, `npm run typecheck`, `npm run build` and the full suite pass. | Implemented on feat/T-01kzrdybqzgpmv3ff0wqv7bbf8-objectless-work-is-retired-by-name-and-the-record-says-what- at b48022e, branched from main.  cancelContract (src/commands/contract.ts) now accepts backlog, defined, active and review; a done contract is refused by name and pointed at reopen. From active and review it removes the claim and the execution worktree and preserves the branch, reusing closeContract's clean-worktree guard rather than releaseClaim, so a contract whose worktree vanished can still be retired instead of being trapped. --reason is required from every state and stored as cancellation_reason; --superseded-by resolves a contract or decision to its canonical id, is stored as superseded_by, and is required for duplicate and obsolete. A supersession that names nothing, names a missing entity, or names the contract itself is refused. The id is canonicalised once so the short form the listings print cannot silently miss the claim and worktree paths. The lifecycle event carries the previous state, resolution, reason, superseding id, claim release and preserved branch; the CLI approval receipt records the same payload. Dependent contracts are reported in the result and never cascaded.  contract.cancel is a gated approval action (src/commands/approval.ts, src/commands/mcp.ts): payload validated for resolution, reason and supersededBy; assertApplicable admits every state but done; approvalDescription puts the resolution, the supersession and the reason into the sentence the human reads. showCommand (src/commands/show.ts) lists a decision's retired contracts, derived from the contracts themselves so decision files keep their three fields.  Verification: npx vitest run tests/integration/contract-cancel.test.ts — 11 tests, covering cancel from backlog, active (claim released, worktree removed, branch alive, event and receipt asserted), review, a vanished worktree, dependents reported, and every refusal (no approval, blank reason, missing --reason, unknown resolution, unnamed/dangling/circular supersession, a second cancel). tests/integration/mcp.test.ts adds the caller-chat path: a payload missing supersededBy is refused before any event is written, and an approved contract.cancel moves the contract to done with proposed/approved/applied. npm run typecheck, npm run build and npx vitest run --exclude '.worktrees/**' all pass: 42 files, 275 passed, 1 skipped. Documentation: README.md, AGENTS.md lifecycle table and prose, skills/close-contract and skills/execute-contract. |
| workflow: happy_path_verified | Implemented on feat/T-01kzrdybqzgpmv3ff0wqv7bbf8-objectless-work-is-retired-by-name-and-the-record-says-what- at b48022e, branched from main.  cancelContract (src/commands/contract.ts) now accepts backlog, defined, active and review; a done contract is refused by name and pointed at reopen. From active and review it removes the claim and the execution worktree and preserves the branch, reusing closeContract's clean-worktree guard rather than releaseClaim, so a contract whose worktree vanished can still be retired instead of being trapped. --reason is required from every state and stored as cancellation_reason; --superseded-by resolves a contract or decision to its canonical id, is stored as superseded_by, and is required for duplicate and obsolete. A supersession that names nothing, names a missing entity, or names the contract itself is refused. The id is canonicalised once so the short form the listings print cannot silently miss the claim and worktree paths. The lifecycle event carries the previous state, resolution, reason, superseding id, claim release and preserved branch; the CLI approval receipt records the same payload. Dependent contracts are reported in the result and never cascaded.  contract.cancel is a gated approval action (src/commands/approval.ts, src/commands/mcp.ts): payload validated for resolution, reason and supersededBy; assertApplicable admits every state but done; approvalDescription puts the resolution, the supersession and the reason into the sentence the human reads. showCommand (src/commands/show.ts) lists a decision's retired contracts, derived from the contracts themselves so decision files keep their three fields.  Verification: npx vitest run tests/integration/contract-cancel.test.ts — 11 tests, covering cancel from backlog, active (claim released, worktree removed, branch alive, event and receipt asserted), review, a vanished worktree, dependents reported, and every refusal (no approval, blank reason, missing --reason, unknown resolution, unnamed/dangling/circular supersession, a second cancel). tests/integration/mcp.test.ts adds the caller-chat path: a payload missing supersededBy is refused before any event is written, and an approved contract.cancel moves the contract to done with proposed/approved/applied. npm run typecheck, npm run build and npx vitest run --exclude '.worktrees/**' all pass: 42 files, 275 passed, 1 skipped. Documentation: README.md, AGENTS.md lifecycle table and prose, skills/close-contract and skills/execute-contract. |
| workflow: failure_and_cancellation_paths_verified | Implemented on feat/T-01kzrdybqzgpmv3ff0wqv7bbf8-objectless-work-is-retired-by-name-and-the-record-says-what- at b48022e, branched from main.  cancelContract (src/commands/contract.ts) now accepts backlog, defined, active and review; a done contract is refused by name and pointed at reopen. From active and review it removes the claim and the execution worktree and preserves the branch, reusing closeContract's clean-worktree guard rather than releaseClaim, so a contract whose worktree vanished can still be retired instead of being trapped. --reason is required from every state and stored as cancellation_reason; --superseded-by resolves a contract or decision to its canonical id, is stored as superseded_by, and is required for duplicate and obsolete. A supersession that names nothing, names a missing entity, or names the contract itself is refused. The id is canonicalised once so the short form the listings print cannot silently miss the claim and worktree paths. The lifecycle event carries the previous state, resolution, reason, superseding id, claim release and preserved branch; the CLI approval receipt records the same payload. Dependent contracts are reported in the result and never cascaded.  contract.cancel is a gated approval action (src/commands/approval.ts, src/commands/mcp.ts): payload validated for resolution, reason and supersededBy; assertApplicable admits every state but done; approvalDescription puts the resolution, the supersession and the reason into the sentence the human reads. showCommand (src/commands/show.ts) lists a decision's retired contracts, derived from the contracts themselves so decision files keep their three fields.  Verification: npx vitest run tests/integration/contract-cancel.test.ts — 11 tests, covering cancel from backlog, active (claim released, worktree removed, branch alive, event and receipt asserted), review, a vanished worktree, dependents reported, and every refusal (no approval, blank reason, missing --reason, unknown resolution, unnamed/dangling/circular supersession, a second cancel). tests/integration/mcp.test.ts adds the caller-chat path: a payload missing supersededBy is refused before any event is written, and an approved contract.cancel moves the contract to done with proposed/approved/applied. npm run typecheck, npm run build and npx vitest run --exclude '.worktrees/**' all pass: 42 files, 275 passed, 1 skipped. Documentation: README.md, AGENTS.md lifecycle table and prose, skills/close-contract and skills/execute-contract. |
| workflow: authorization_and_idempotency_verified | Implemented on feat/T-01kzrdybqzgpmv3ff0wqv7bbf8-objectless-work-is-retired-by-name-and-the-record-says-what- at b48022e, branched from main.  cancelContract (src/commands/contract.ts) now accepts backlog, defined, active and review; a done contract is refused by name and pointed at reopen. From active and review it removes the claim and the execution worktree and preserves the branch, reusing closeContract's clean-worktree guard rather than releaseClaim, so a contract whose worktree vanished can still be retired instead of being trapped. --reason is required from every state and stored as cancellation_reason; --superseded-by resolves a contract or decision to its canonical id, is stored as superseded_by, and is required for duplicate and obsolete. A supersession that names nothing, names a missing entity, or names the contract itself is refused. The id is canonicalised once so the short form the listings print cannot silently miss the claim and worktree paths. The lifecycle event carries the previous state, resolution, reason, superseding id, claim release and preserved branch; the CLI approval receipt records the same payload. Dependent contracts are reported in the result and never cascaded.  contract.cancel is a gated approval action (src/commands/approval.ts, src/commands/mcp.ts): payload validated for resolution, reason and supersededBy; assertApplicable admits every state but done; approvalDescription puts the resolution, the supersession and the reason into the sentence the human reads. showCommand (src/commands/show.ts) lists a decision's retired contracts, derived from the contracts themselves so decision files keep their three fields.  Verification: npx vitest run tests/integration/contract-cancel.test.ts — 11 tests, covering cancel from backlog, active (claim released, worktree removed, branch alive, event and receipt asserted), review, a vanished worktree, dependents reported, and every refusal (no approval, blank reason, missing --reason, unknown resolution, unnamed/dangling/circular supersession, a second cancel). tests/integration/mcp.test.ts adds the caller-chat path: a payload missing supersededBy is refused before any event is written, and an approved contract.cancel moves the contract to done with proposed/approved/applied. npm run typecheck, npm run build and npx vitest run --exclude '.worktrees/**' all pass: 42 files, 275 passed, 1 skipped. Documentation: README.md, AGENTS.md lifecycle table and prose, skills/close-contract and skills/execute-contract. |

### Verification performed

Implemented on feat/T-01kzrdybqzgpmv3ff0wqv7bbf8-objectless-work-is-retired-by-name-and-the-record-says-what- at b48022e, branched from main.

cancelContract (src/commands/contract.ts) now accepts backlog, defined, active and review; a done contract is refused by name and pointed at reopen. From active and review it removes the claim and the execution worktree and preserves the branch, reusing closeContract's clean-worktree guard rather than releaseClaim, so a contract whose worktree vanished can still be retired instead of being trapped. --reason is required from every state and stored as cancellation_reason; --superseded-by resolves a contract or decision to its canonical id, is stored as superseded_by, and is required for duplicate and obsolete. A supersession that names nothing, names a missing entity, or names the contract itself is refused. The id is canonicalised once so the short form the listings print cannot silently miss the claim and worktree paths. The lifecycle event carries the previous state, resolution, reason, superseding id, claim release and preserved branch; the CLI approval receipt records the same payload. Dependent contracts are reported in the result and never cascaded.

contract.cancel is a gated approval action (src/commands/approval.ts, src/commands/mcp.ts): payload validated for resolution, reason and supersededBy; assertApplicable admits every state but done; approvalDescription puts the resolution, the supersession and the reason into the sentence the human reads. showCommand (src/commands/show.ts) lists a decision's retired contracts, derived from the contracts themselves so decision files keep their three fields.

Verification: npx vitest run tests/integration/contract-cancel.test.ts — 11 tests, covering cancel from backlog, active (claim released, worktree removed, branch alive, event and receipt asserted), review, a vanished worktree, dependents reported, and every refusal (no approval, blank reason, missing --reason, unknown resolution, unnamed/dangling/circular supersession, a second cancel). tests/integration/mcp.test.ts adds the caller-chat path: a payload missing supersededBy is refused before any event is written, and an approved contract.cancel moves the contract to done with proposed/approved/applied. npm run typecheck, npm run build and npx vitest run --exclude '.worktrees/**' all pass: 42 files, 275 passed, 1 skipped. Documentation: README.md, AGENTS.md lifecycle table and prose, skills/close-contract and skills/execute-contract.

### Deviations

Two, both corrections to the contract's own execution notes rather than to its scope.

1. The note "cancel has no test coverage today" was wrong. tests/integration/contract-cancel.test.ts existed and asserted the removed behaviour — that cancel refuses an active contract. The grep behind the note looked for the cancelContract symbol, which the CLI-driven tests never import. That file was rewritten rather than added to, and the assertion it made is now the opposite one.

2. Two unrelated tests cancelled a fixture contract with --resolution obsolete and nothing superseding it: tests/integration/batch.test.ts and tests/integration/state-duplication.test.ts. Both were changed to --resolution cancelled with a stated reason, which is the truthful resolution when no entity took the work's place. Neither test asserts anything about the resolution word.

Ordering against the collision named in the contract: T-01kzhnsncw8znqdn14rf5d4tfp moved to review during this work and is not merged, so this branch is cut from a main that has no revise. Neither is integrated yet, and whichever merges second reconciles the approval enum and the neighbouring lines in src/commands/contract.ts. T-01kzda6nj9hd2z45tt06fw8n0g is still unstarted; its "same five actions stay gated" invariant is now six here and seven once revise lands.
...
The shipped skills changed, so an installed copy of close-contract or execute-contract will report as drifted until kotta sync runs. Nothing in this branch installs them.

--superseded-by resolves against the workspace at cancellation time. A retired contract keeps a link to an entity that is later removed by hand; nothing re-validates it afterwards, and the contract does not ask for that.
