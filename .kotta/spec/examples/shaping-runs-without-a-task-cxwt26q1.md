...
An operator exploring a feature idea in conversation - actors, a use case, boundary examples - before committing to any work.

## When

A workshop drafts the corresponding specification nodes under the spec namespace, and traceability runs.
